...
//In SC_ADRESStemp, 23 means row_2 column_3//
int SC_ADRESStemp[8][8] =
    {
 ...
 ********************************************************************************/
void SC_Channel2SiPMtemp(short F_DB, short mChannel, short *mSiPM)
{
    int FPGA;
    int DB;
    double SC_X;
    ...
    FPGA = F_DB%10;
    DB = F_DB/10;
    SC_X = SC_ADRESStemp[DB-1][FPGA-1]%10;
    SC_Y = SC_ADRESStemp[DB-1][FPGA-1]/10;
 ...
 *********************************************************************************/
void SiPM2SC_Channeltemp(short mSiPM, short *mSC, short *mChannel)
{
  *mSC = sipm2SCtemp[mSiPM];
  *mChannel = sipm2Channeltemp[mSiPM];
}
 ...
 *******************************************************************************/
void SC_Channel2eSiPMtemp(short fpga, short db, short channel, short *sipm)
{
 ...
 * range of esipm is [1,1024]                                                  *
 *******************************************************************************/
void eSiPM2SC_Channeltemp(short mSiPM, short *mSC, short *mChannel)
{
  short modfpga;
  short moddb;
